...
public class BetterDecoJEIPlugin implements IModPlugin {
    ...
    public void registerCategories(IRecipeCategoryRegistration registration) {
        registration.addRecipeCategories(new OvenCategory(
                registration.getJeiHelpers().getGuiHelper()));

        registration.addRecipeCategories(new MicrowaveCategory(
                registration.getJeiHelpers().getGuiHelper()
        ));
    }
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        registration.addRecipes(OvenCategory.OVEN_RECIPE_RECIPE_TYPE, ovenRecipes);
        ...
        registration.addRecipes(MicrowaveCategory.MICROWAVE_RECIPE_RECIPE_TYPE, microwaveRecipes);
    ...
    public void registerGuiHandlers(IGuiHandlerRegistration registration) {
        registration.addRecipeClickArea(OvenScreen.class, 74, 30, 22, 20,
                OvenCategory.OVEN_RECIPE_RECIPE_TYPE);
        registration.addRecipeClickArea(MicrowaveScreen.class, 74, 30, 22, 20,
                MicrowaveCategory.MICROWAVE_RECIPE_RECIPE_TYPE);
