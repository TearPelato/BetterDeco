      ...
      implements IRecipeCategory<MicrowaveRecipe>
{
    ...
    public static final ResourceLocation UID = new ResourceLocation(BetterDeco.MOD_ID, "microwave");
    public static final ResourceLocation TEXTURE = new ResourceLocation(BetterDeco.MOD_ID,
