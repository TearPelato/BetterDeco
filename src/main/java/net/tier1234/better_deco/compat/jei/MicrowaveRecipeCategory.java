...
public class MicrowaveRecipeCategory implements IRecipeCategory<MicrowaveRecipe> {
    ...
    public static final IRecipeType<MicrowaveRecipe> MICROWAVE_RECIPE_RECIPE_TYPE =
            new IRecipeType<>() {
                @Override
                ...
                @Override
                public Class<? extends MicrowaveRecipe> getRecipeClass() {
                    return MicrowaveRecipe.class;
                }
            };
    ...
    @Override
    public IRecipeType<MicrowaveRecipe> getRecipeType() {
