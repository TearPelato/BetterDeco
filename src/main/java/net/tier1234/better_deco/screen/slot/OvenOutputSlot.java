...
public class OvenOutputSlot extends ResourceHandlerSlot {


    public OvenOutputSlot(ResourceHandler<ItemResource> handler, IndexModifier<ItemResource> slotModifier, int handlerSlot, int xPosition, int yPosition) {
