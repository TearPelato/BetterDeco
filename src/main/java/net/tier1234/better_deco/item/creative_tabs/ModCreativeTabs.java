...
public class ModCreativeTabs {
    ...
    public static final Supplier<CreativeModeTab> UTILITIES = CREATIVE_MODE_TAB.register("utilities",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModBlocks.STONE_PEDESTAL.get()))
                    .title(Component.translatable("creativetab.better_deco.utilities"))
                    .displayItems((itemDisplayParameters, output) -> {
